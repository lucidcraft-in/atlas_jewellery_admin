...
class Cancelationplcy extends StatefulWidget {
  const Cancelationplcy({super.key});

  @override
  State<Cancelationplcy> createState() => _CancelationplcyState();
}

class _CancelationplcyState extends State<Cancelationplcy> {
  List userlist = [];
  bool isLoading = true;
  ...
  getData() async {
    ...
    CollectionReference collectionReference =
        FirebaseFirestore.instance.collection('cancelationPolicy');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Cancelation Policy'),
      ),
      body: isLoading
